      ...
      <div className="container mx-auto px-4 py-6">
        ...
        {!noData && (
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
            ...
            <Card 
              className="cursor-pointer hover:shadow-md transition-all duration-200 border-2 hover:border-green-300 bg-gradient-to-br from-green-50 to-emerald-50"
              onClick={() => setActiveTab('carbon')}
            >
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium flex items-center space-x-1">
                  <span>Carbon Footprint</span>
                  <Badge className="bg-green-100 text-green-700 text-xs">Advanced</Badge>
                </CardTitle>
              ...
              <CardContent>
                ...
                <p className="text-xs text-gray-600 mb-2">CO₂ monthly {simulationRunning ? '(Live)' : ''}</p>
                <Button 
                  variant="outline" 
                  size="sm" 
